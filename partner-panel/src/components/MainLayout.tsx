...
export const MainLayout = ({ children }: MainLayoutProps) => {
  ...
  // Используем данные из useAuth; без дефолтных моков
  const user: User | undefined = authUser || undefined;
        ...
        <Header className="partner-header">
          ...
          >
            <Badge 
              ...
              size="small"
              style={{ backgroundColor: notifications.some((n: any) => !n.read) ? '#689071' : '#d9d9d9' }}
            >
