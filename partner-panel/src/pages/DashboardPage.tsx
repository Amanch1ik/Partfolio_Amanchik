import { Card, Row, Col, Statistic, Button, Space, Tag, Spin } from 'antd';
import {
  DollarOutlined,
  LineChartOutlined,
  PlusOutlined,
...
export const DashboardPage = () => {
  const { data: stats, isLoading, error } = useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        // В продакшене при ошибке просто возвращаем null и показываем нули/\"нет данных\"
        console.error('Dashboard API недоступен:', err);
        return null;
      }
    },
    retry: 1,
  ...
  // Используем реальные данные или нули, без мок-значений
