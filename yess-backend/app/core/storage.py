...
class FileStorage:
    ...
    def validate_file(self, file: UploadFile, allowed_extensions: Optional[Iterable[str]] = None) -> None:
        ...
        if file.filename:
            ...
            allowed = list(allowed_extensions) if allowed_extensions else settings.ALLOWED_IMAGE_EXTENSIONS
